...
void setup()
{
  ...
  dxl_wb.addSyncWriteHandler("Goal_Position");
  dxl_wb.addSyncReadHandler("Present_Current");
  dxl_wb.addSyncReadHandler("Present_Position");
  dxl_wb.addSyncReadHandler("Present_Velocity");
}
